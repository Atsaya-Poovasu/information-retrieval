...
class SentimentClassifier():
    ...
    def __init__(self, folder):
        ...
        self.universities_by_sentiment = pd.read_csv('world_rankings_with_twitter.csv')
    ...
    def classify_folder(self):
        ...
        unis = pd.read_csv('world_rankings_with_twitter.csv')
        ...
        self.result.to_csv("universities_by_sentiment")
...
if __name__ == "__main__":
    ...
    emp_df = pd.read_csv('universities_by_sentiment.csv')
    sorted_df = emp_df.sort_values(by='happiness_ranking')
    print(sorted_df(10));
